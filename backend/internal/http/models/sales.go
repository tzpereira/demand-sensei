...
type SalesRecord struct {
	...
	Quantity       int     `csv:"quantity" validate:"required"`
	...
	UnitPrice      float64 `csv:"unit_price,omitempty"`
	Revenue        float64 `csv:"revenue,omitempty"`
	Discount       float64 `csv:"discount,omitempty"`
	...
	IsNewCustomer  bool    `csv:"is_new_customer,omitempty"`
	ShippingMethod string  `csv:"shipping_method,omitempty"`
	ShippingDays   int     `csv:"shipping_days,omitempty"`
	ShippingCost   float64 `csv:"shipping_cost,omitempty"`
